...
function jokeFnc(num) {
    ...
    return blockGenerator_random(joke[num]);
}

// letters
function letterFnc() {
    var contextWel = "Your consciousness and thoughts are stored in them and when you read it, it’s like you are being contacted by the old you. ✍💌"
    ...
    console.log("letter");
    return blockGenerator(welText, links, thumb, context, alt_text, contextWel)
}

// recipes
function recipeFnc() {
    var contextWel = "Food has an amazing power to connect people (and kittens). And there’s just nothing better than being cooked something amazing. Remember the last time someone cook something delicious for you. Did you feel special? (give me some fish paw-lease) 🍜🌭"
...
// photos
function photosFnc() {
    var contextWel = "When you see a paw-oto of yourself smiling, you often instinctively smile back, which elicits a feeling of happiness. 🤳📸"
...
// books
function booksFnc() {
    var contextWel = "Reading a book can make one fur-get about their surroundings. It teaches one to focus and concentrate on one thing at a time. 📕📚"
...
// cleaning
function cleanFnc() {
    var contextWel = "The act of cleaning can bring the added benefit of getting you a little extra exercise, which can be great for relieving stress. 🧹🧽"
...
// calling
function callFnc() {
    var contextWel = "Purr-haps one of the most crucial things we can do to help our loved ones through this trying time is to check in with them every day. 📞"
...
function languageFnc() {
    var contextWel = "Language learning helps improve people's thinking skills and memory abilities. Learning a second language can develop new areas of your mind and strengthen your brain's natural ability to focus. 🧠"
...
function meditateFnc() {
    var contextWel = "People staying indoors could benefit from yoga which helps boost immunity. 🤸‍♀️🏋️‍♂️"
...
// movies
function movieFnc() {
    var contextWel = "One of the great rewards of watching fur-eign films is the infinite ways it can open up the world for you as a viewer. 🎥🎬"
...
// resting
function restFnc() {
    var contextWel = "Today is your day to love yourself, rest and sleep endlessly (just like me) 💤😴🛌"
    var welText = "*Just relax, rest and sleep*"
    console.log("rest");
    return blockGenerator_noblock(welText, contextWel)
}

// thankyou
function thankyouFnc() {
    var contextWel = "To our parents, friends, children, paw-tners, doctors, nurses, garbage-man, delivery guy, neighbour, and everyone else too! (don't forget me) 🙏🤗"
...
function re_arrangeFnc() {
    var contextWel = "You can easily revitalize stale family rooms and bedrooms anytime by rearranging furniture to create a fresh, new look. ⚒🧱"
...
// music
function musicFnc() {
    var contextWel = "Here's my collection of playlist, relaxing and fur-esh music 🎷🎵"
...
// skills
function skillsFnc() {
    var contextWel = "Now is a great time to get focused and learn a skill you've been wanting to learn from a long time 🎨🏓"
...
// family
function familyFnc() {
    var contextWel = "Let's spend time with our loved ones, calling them, spending time with them, talking to them, playing with the kids! It's a wonderful feeling! 👪"
...
function socialchallengeFnc() {
    var contextWel = "Online challenges are trending on twitter, instagram and other places. Take part in challenges that encourage social distancing, welfare and healthy habits 🤳✌"
...
function socialserviceFnc() {
    var contextWel = "There are many ways you can contribute towards social service, like donating, making home-made masks, food service, motivating other fighting against the virus 😷"
...
// anime
function animeFnc() {
    var contextWel = "Here is a small list of some of my favourite ones.  🎌🎎"
    ...
    console.log("anime");
    return blockGenerator_moreblock(welText, links, thumb, context, alt_text, contextWel)
}
...
function blockGenerator_noblock(welText, contextWel) {
    return [{
            "type": "section",
            "text": {
                "type": "mrkdwn",
...
function blockGenerator_random(welText) {
    return [{
        "type": "section",
        "text": {
            "type": "mrkdwn",
...
function blockGenerator_moreblock(welText, links, thumb, context, alt_text, contextWel) {
    return [{
            "type": "section",
            "text": {
                "type": "mrkdwn",
